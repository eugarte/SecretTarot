...
using Moq;
using SecretTarot.Module.Core.Components;
using SecretTarot.Module.Core.Data;
using SecretTarot.Module.Core.Extensions;
using SecretTarot.Module.Core.Models;
using SecretTarot.Module.Core.ViewModels.Manage;
using Xunit;

namespace SecretTarot.Module.Core.Tests.Components
{
    /*
    ...
    public class DefaultShippingAddressViewComponentTests
    {
        ...
        public async Task DefaultAddressViewComponetn_ShouldReturns_CorrectViewName()
        {
            ...
            Assert.Equal("/Modules/SecretTarot.Module.Core/Views/Components/DefaultShippingAddress.cshtml", view?.ViewName);
        }
