...
namespace SecretTarot.WebHost.Migrations
{
    public partial class SecretTarot_1_0_0_RC : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2L, 0, "101cd6ae-a8ef-4a37-97fd-04ac2dd630e4", new DateTimeOffset(new DateTime(2018, 5, 29, 4, 33, 39, 189, DateTimeKind.Unspecified), new TimeSpan(0, 7, 0, 0, 0)), null, null, "system@SecretTarot.com", false, "System User", true, false, null, "SYSTEM@SecretTarot.COM", "SYSTEM@SecretTarot.COM", "AQAAAAEAACcQAAAAEAEqSCV8Bpg69irmeg8N86U503jGEAYf75fBuzvL00/mr/FGEsiUqfR0rWBbBUwqtw==", null, false, "a9565acb-cee6-425f-9833-419a793f5fba", false, new DateTimeOffset(new DateTime(2018, 5, 29, 4, 33, 39, 189, DateTimeKind.Unspecified), new TimeSpan(0, 7, 0, 0, 0)), new Guid("5f72f83b-7436-4221-869c-1b69b2e23aae"), "system@SecretTarot.com", null },
                    { 10L, 0, "c83afcbc-312c-4589-bad7-8686bd4754c0", new DateTimeOffset(new DateTime(2018, 5, 29, 4, 33, 39, 190, DateTimeKind.Unspecified), new TimeSpan(0, 7, 0, 0, 0)), null, null, "admin@SecretTarot.com", false, "Shop Admin", false, false, null, "ADMIN@SecretTarot.COM", "ADMIN@SecretTarot.COM", "AQAAAAEAACcQAAAAEAEqSCV8Bpg69irmeg8N86U503jGEAYf75fBuzvL00/mr/FGEsiUqfR0rWBbBUwqtw==", null, false, "d6847450-47f0-4c7a-9fed-0c66234bf61f", false, new DateTimeOffset(new DateTime(2018, 5, 29, 4, 33, 39, 190, DateTimeKind.Unspecified), new TimeSpan(0, 7, 0, 0, 0)), new Guid("ed8210c3-24b0-4823-a744-80078cf12eb4"), "admin@SecretTarot.com", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "TableRate", null, "shipping-table-rate-config", true, "Table Rate", null, null, "SecretTarot.Module.ShippingTableRate.Services.TableRateShippingServiceProvider,SecretTarot.Module.ShippingTableRate", true, true },
                    { "FreeShip", "{MinimumOrderAmount : 100}", "", true, "Free Ship", null, null, "SecretTarot.Module.ShippingFree.Services.FreeShippingServiceProvider,SecretTarot.Module.ShippingFree", true, true }
                });
