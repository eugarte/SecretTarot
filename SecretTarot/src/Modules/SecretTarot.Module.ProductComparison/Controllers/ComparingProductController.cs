...
using SecretTarot.Module.ProductComparison.Models;
using SecretTarot.Module.ProductComparison.Services;
using SecretTarot.Module.ProductComparison.ViewModels;
using SecretTarot.Module.Catalog.Services;

namespace SecretTarot.Module.ProductComparison.Controllers
{
