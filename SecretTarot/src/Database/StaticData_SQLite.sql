...
INSERT INTO Core_User (Id, UserGuid, FullName, IsDeleted, CreatedOn, UpdatedOn, UserName, NormalizedUserName, Email, NormalizedEmail, EmailConfirmed, PasswordHash, SecurityStamp, ConcurrencyStamp, PhoneNumber, PhoneNumberConfirmed, TwoFactorEnabled, LockoutEnd, LockoutEnabled, AccessFailedCount) VALUES (2, '4653d7e5-f5ca-4813-a782-3385ca9739bc', 'System', 1, '2016-05-12 23:44:13', '2016-05-12 23:44:13.297', 'system@SecretTarot.com', 'SYSTEM@SecretTarot.COM', 'system@SecretTarot.com', 'SYSTEM@SecretTarot.COM', 0, 'AQAAAAEAACcQAAAAEAEqSCV8Bpg69irmeg8N86U503jGEAYf75fBuzvL00/mr/FGEsiUqfR0rWBbBUwqtw==', '9e87ce89-64c0-45b9-8b52-6e0eaa79e5b8', '8620916f-e6b6-4f12-9041-83737154b339', NULL, 0, 0, '2050-05-12 23:44:13.297', 1, 0);
INSERT INTO Core_User (Id, UserGuid, FullName, IsDeleted, CreatedOn, UpdatedOn, UserName, NormalizedUserName, Email, NormalizedEmail, EmailConfirmed, PasswordHash, SecurityStamp, ConcurrencyStamp, PhoneNumber, PhoneNumberConfirmed, TwoFactorEnabled, LockoutEnd, LockoutEnabled, AccessFailedCount) VALUES (10, '1FFF10CE-0231-43A2-8B7D-C8DB18504F65', 'Shop Admin', 0, '2016-05-12 23:44:13', '2016-05-12 23:44:13.297', 'admin@SecretTarot.com', 'ADMIN@SecretTarot.COM', 'admin@SecretTarot.com', 'ADMIN@SecretTarot.COM', 0, 'AQAAAAEAACcQAAAAEAEqSCV8Bpg69irmeg8N86U503jGEAYf75fBuzvL00/mr/FGEsiUqfR0rWBbBUwqtw==', '9e87ce89-64c0-45b9-8b52-6e0eaa79e5b7', '8620916f-e6b6-4f12-9041-83737154b338', NULL, 0, 0, NULL, 1, 0);
...
INSERT INTO Core_Address (Id, AddressLine1, ContactName, CountryId, DistrictId, Phone, StateOrProvinceId, City, ZipCode) VALUES (1, NULL, 'SecretTarot', 238, NULL, NULL, 93, NULL, NULL);

INSERT INTO Inventory_Warehouse (Id, AddressId, Name) VALUES (1, 1, 'Default warehouse');

INSERT INTO Shipping_ShippingProvider (Id, AdditionalSettings, ConfigureUrl, IsEnabled, Name, OnlyCountryIdsString, OnlyStateOrProvinceIdsString, ShippingPriceServiceTypeName, ToAllShippingEnabledCountries, ToAllShippingEnabledStatesOrProvinces) VALUES (1, '{MinimumOrderAmount : 100}', 'shipping-free-config', 1, 'Free Ship', NULL, NULL, 'SecretTarot.Module.ShippingFree.Services.FreeShippingServiceProvider,SecretTarot.Module.ShippingFree', 1, 1);
INSERT INTO Shipping_ShippingProvider (Id, AdditionalSettings, ConfigureUrl, IsEnabled, Name, OnlyCountryIdsString, OnlyStateOrProvinceIdsString, ShippingPriceServiceTypeName, ToAllShippingEnabledCountries, ToAllShippingEnabledStatesOrProvinces) VALUES (2, NULL, 'shipping-table-rate-config', 1, 'Table Rate', NULL, NULL, 'SecretTarot.Module.ShippingTableRate.Services.TableRateShippingServiceProvider,SecretTarot.Module.ShippingTableRate', 1, 1);
